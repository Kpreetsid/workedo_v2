...
export default function Requests() {
    return (
        <>
            ...
            <SegmentedPager tabs={[{label: "Pending", icon: <FontAwesome6 name="circle-exclamation" size={12}/>, component: <PendingRequests/>},
                {label: "Done", icon: <DoneIcon/>, component: <DoneRequests/>}]}/>

            <CreateFAB label="Create Request" onPress={() => router.push("/newWorkOrder")}/>
        </>
    )
}