import { RefreshControl, ScrollView, StyleSheet, Text, ToastAndroid, TouchableOpacity, View } from "react-native";
import { useEffect, useMemo, useRef, useState } from "react";
import { fetchAssetChildren, getAllEndpoints, getSingleAssetHealthHistory } from "@/src/services/asset.service";
...
import { useGestureLock } from "@/src/state/auth/useGestureLock";
...
export default function AssetInfoTab({ asset_data, composite_idFromParams, refreshing, onRefresh }: AssetInfoTabProps) {
    ...
    // @ts-ignore
	const [setActiveTab] = useState("Horizontal");
    // @ts-ignore
