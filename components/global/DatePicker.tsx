				...
				<Pressable style={styles.container} onPress={event => event.stopPropagation()}>
...

					{
						showMonthDropdown || showYearDropdown ?
							<View style={{ flexDirection: "row", justifyContent: "space-between", height: 200, backgroundColor: 'transparent', position: 'relative' }}>
								{showYearDropdown && (
									<View style={[styles.dropdownList, {position: 'absolute', left: 0, top: 0, width: '44%'}]}>
								...
								{showMonthDropdown && (
									<View style={[styles.dropdownList, {position: 'absolute', right: 0, top: 0, width: '44%'}]}>
										<ScrollView style={{ maxHeight: 200 }}>
