...
export default function ActionButton({ label, onPress, icon, disabled, style }: ActionButtonProps) {
    return (
        <TouchableOpacity style={[styles.registerBtn, style]} onPress={onPress} activeOpacity={0.8} disabled={disabled}>
